...
# March 2025: Beka is updating the script ####
# 1. to accommodate changes to the structure of the taxa translator table and attributes table coming from the BCG work group materials.
# 2. Create a uniquely named output folder where csv files and plots go in order to keep prior runs for comparison, and easily delete an entire run when it isn't needed.
